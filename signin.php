...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if ((!empty($Email) && !empty($Password))) {
    ...
    $id = $user_id;
    $query = " insert into customer ( user_id, id, Email, Password) values ('$user_id', '$id', '$Email', '$Password')";
...
<body>
  ...
  <div class="container">
    ...
    <div class="top">
      <div class="text">
      <p style= "text-align:center; font-size:30px; color:white;">Sign Up </p>
      <h3 style="font-size: 15px; text-align: center; opacity: 80%; color: white;">Register your account by filling up this form. Please fill up all the information required in this section.</h3>
   </div>
    </div>
   ...
   left: 50%;
    ...
    text-align: center;
    color: white;"  class="input-container">
      <form method="post">
    ...
    "  class="inputbox">
        ...
        <p style="font-size: 15px; text-align: center; color: white;">Have an account? <a style="font-size: 15px; text-decoration: underline; color:white" href="login.php#login"> Login now</a></p>
    <div class="log">
      </form>
    </div>
